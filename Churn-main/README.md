...
2. **Neural Network (Multi-Layer Perceptron) Machine Learning Pipeline**:
   - Supervised Deep Learning / Artificial Neural Network model (`sklearn.neural_network.MLPClassifier`) for predicting churn probability and risk tier (`LOW`, `MEDIUM`, `HIGH`).
