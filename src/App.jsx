...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F4F0FA] font-sans text-stone-800 flex flex-col antialiased relative">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-[50px] py-4 sm:py-6 flex-1 flex flex-col relative">
        ...
        {/* BRANDING TITLE — Aligned cleanly directly below the header */}
        <div className="mb-6 sm:mb-8 flex items-center space-x-3.5 sm:space-x-4">
